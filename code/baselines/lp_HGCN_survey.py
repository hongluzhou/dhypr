...
for fold in range(total_folds):
    for run_count in range(total_run):
        ...
        while not success:
            ...
            command = "CUDA_VISIBLE_DEVICES=0 python train.py --task {} --dataset {} --model HGCN --manifold {} --dropout 0.1 --gamma 0.1 --lr 0.01 --momentum 0.999 --weight-decay 0.001 --hidden 64 --dim 32 --num-layers 2 --act relu --bias 1 --fold {} --seed {} --save-dir {} --epochs 500".format(
                                            task,
                                            dataset,
                                            manifold,
                                            fold,
