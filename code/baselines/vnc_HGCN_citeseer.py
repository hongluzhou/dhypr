...
for fold in range(total_folds):
    ...
    while not success:
        ...
        command = "CUDA_VISIBLE_DEVICES=0 python train.py --task {} --dataset {} --model HGCN --manifold {} --dropout 0.05 --gamma 1.0 --lr 0.01 --momentum 0.9 --weight-decay 0.001 --hidden 64 --dim 32 --num-layers 2 --act relu --bias 1 --fold {} --seed {} --save-dir {} --epochs 500 --patience 50 --vnc 1".format(
                                            task,
                                            dataset,
                                            manifold,
                                            fold,
