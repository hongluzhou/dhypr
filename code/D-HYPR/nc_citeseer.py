...
for fold in range(total_folds):
    ...
    while not success:
        ...
        command = "CUDA_VISIBLE_DEVICES=0 python train.py --task nc --dataset {} --model DHYPR --manifold PoincareBall --dropout 0.05 --gamma 0.5 --lr 0.01 --momentum 0.9 --weight-decay 0.001 --hidden 64 --dim 32 --num-layers 2 --act relu --bias 1 --fold {} --seed {} --save-dir {} --epochs 500 --lamb 0.5 --wl2 5 --wlp 0.5 --patience 50".format(dataset, fold, seed_this, save_dir)
